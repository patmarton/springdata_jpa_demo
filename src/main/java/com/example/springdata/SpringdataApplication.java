...
public class SpringdataApplication {
    ...
    public CommandLineRunner demo(CustomerRepository repository) {
        return (args) -> {
            ...
            repository.save(new Customer("Jack", "Ryan"));
            repository.save(new Customer("Cust", "Brian"));
            repository.save(new Customer("Kimmy", "Cust"));
            repository.save(new Customer("David", "Smith"));
            repository.save(new Customer("Custtwo", "Romo"));
            ...
            log.info("Customer found with findByLastName('Ryan'):");
            log.info("--------------------------------------------");
            repository.findByLastName("Ryan").forEach(ryan -> {
